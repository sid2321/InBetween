...
describe('akeneo v1 showcase login open publication', () => {
    ...
    it('preview pages in builder tab', () => {
        ...
        cy.get('[alt="Loading..."]',{ timeout: 150000000 }).should('not.exist')
        cy.get('[alt="No Products To Preview"]',{ timeout: 150000000 }).should('have.length',4)
    })
    ...
    it('convert in finishing page to indd', () => {
        ...
        cy.get(elementBuilderManager.dialogBox).within(() => {
            cy.get(elementBuilderManager.convertApproval).click()
        })
    ...
    it.only('generate indd and pdf pulications',() => {
